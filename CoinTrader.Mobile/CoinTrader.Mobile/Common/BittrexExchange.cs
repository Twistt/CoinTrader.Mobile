...
namespace CoinTrader.Mobile.Common
{
    ...
    {
        public static bool APIKeyisInvalid = false;
        ...
        internal static void GetOrderHistory()
        {
            ...
            {
                //ToDo: This can be simplified but its easy to find and fix issues with it broken out.
        ...
        public static string AdvancedAuth(string uri)
        {
            ...
            var requestResult = WebRequest(web, "apisign", sign);
